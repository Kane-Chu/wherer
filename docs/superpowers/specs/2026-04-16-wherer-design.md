...
### 3.2 后续扩展（第二阶段）
- **批量操作**：支持多选物品进行批量删除、批量移动到其他空间
- **快速移动**：在物品详情页或列表中一键将物品转移至其他空间
- iOS 小组件（快速搜索/最新物品）
- Siri / 快捷指令支持（"我的相机放哪了"）
- 到期提醒（"半年后提醒我换季衣服在哪"）
...
| 配色名称 | 渐变值 | 风格 |
|----------|--------|------|
| 暖阳橙 | `#ffeaa7` → `#fab1a0` | 温暖、居家 |
| 薄荷青 | `#a8edea` → `#fed6e3` | 清新、自然 |
| 薰衣草 | `#d299c2` → `#fef9d7` | 柔和、优雅 |
| 天空蓝 | `#89f7fe` → `#66a6ff` | 明快、通透 |
| 森林绿 | `#d4fc79` → `#96e6a1` | 生机、健康 |
| 珊瑚粉 | `#ff9a9e` → `#fecfef` | 活泼、甜美 |
| 深海蓝 | `#a1c4fd` → `#c2e9fb` | 沉静、专业 |
| 落日红 | `#ffecd2` → `#fcb69f` | 复古、温馨 |
